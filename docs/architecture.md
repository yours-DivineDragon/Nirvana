...
| Verification router | Cheapest suitable static, dynamic, symbolic, formal, differential verifier | Adapter-bound assertions, structural corroboration, and strict/semantic replay implemented |
