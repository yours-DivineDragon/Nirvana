...
| Benchmark contamination | Cutoff checks across training/retrieval/rules, blocked ground truth and eventual fixes, hidden-variant transformation hashes, and archived trial provenance |
