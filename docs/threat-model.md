...
| Benchmark contamination or one-case overclaim | Cutoff checks across training/retrieval/rules, blocked ground truth and eventual fixes, independent encrypted case-pack hashes, hidden-variant transformation hashes, repeat seeds, benign controls, and archived trial provenance |
